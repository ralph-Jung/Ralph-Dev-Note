...
> 태그: #spring-security #authentication #login #jwt #authenticationmanager #userdetailsservice #passwordencoder
> 다음에 팔 것: 회원가입(signup) 구현, Refresh 토큰, AuthenticationEntryPoint로 401/403 JSON 통일
